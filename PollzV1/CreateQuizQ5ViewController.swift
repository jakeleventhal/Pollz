//
//  CreateQuizQ5ViewController.swift
//  PollzV1
//
...
class CreateQuizQ5ViewController: UIViewController, UITextFieldDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func submitQuiz(sender: AnyObject) {
        ...
        currentCreatingQuiz.getObjectInBackgroundWithId(currentCreatingObjID) {
            ...
            if error == nil && quizData != nil {
                quizData!["question5"] = self.questionField.text
                
                quizData!["q5A1"] = self.answer1Field.text
                quizData!["q5A2"] = self.answer2Field.text
                quizData!["q5A3"] = self.answer3Field.text
                quizData!["q5A4"] = self.answer4Field.text
                ...
                quizData!["answer5"] = self.correctAnswer
                ...
                if self.questionField.text != "" && self.answer1Field.text != "" && self.answer2Field.text != "" && self.answer3Field.text != "" && self.answer4Field.text != "" {
                    ...
                    self.performSegueWithIdentifier("goQuizzesAfterCreate", sender: sender)
                }
            } else {
                print(error)
            }
