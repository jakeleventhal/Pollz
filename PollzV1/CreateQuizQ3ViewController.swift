//
//  CreateQuizQ3ViewController.swift
//  PollzV1
//
...
class CreateQuizQ3ViewController: UIViewController, UITextFieldDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func nextQuestion(sender: AnyObject) {
        ...
        currentCreatingQuiz.getObjectInBackgroundWithId(currentCreatingObjID) {
            ...
            if error == nil && quizData != nil {
                quizData!["question3"] = self.questionField.text
                
                quizData!["q3A1"] = self.answer1Field.text
                quizData!["q3A2"] = self.answer2Field.text
                quizData!["q3A3"] = self.answer3Field.text
                quizData!["q3A4"] = self.answer4Field.text
                ...
                quizData!["answer3"] = self.correctAnswer
                ...
                if self.questionField.text != "" && self.answer1Field.text != "" && self.answer2Field.text != "" && self.answer3Field.text != "" && self.answer4Field.text != "" {
                    ...
                    self.performSegueWithIdentifier("toCreateQ4", sender: sender)
                }
            } else {
                print(error)
            }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if "toCreateQ4" == segue.identifier {
            let dest = segue.destinationViewController as! CreateQuizQ4ViewController
            dest.Q4ID = currentCreatingObjID
        }
    }
}