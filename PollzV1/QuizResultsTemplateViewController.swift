//
//  QuizResultsTemplateViewController.swift
//  PollzV1
//
...
class QuizResultsTemplateViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let user = PFUser.currentUser() {
            ...
            q1Query.whereKey("objectId", equalTo: (quizCont4?.objectId)!)
        ...
        if let user = PFUser.currentUser() {
            ...
            q2Query.whereKey("objectId", equalTo: (quizCont4?.objectId)!)
        ...
        if let user = PFUser.currentUser() {
            ...
            q3Query.whereKey("objectId", equalTo: (quizCont4?.objectId)!)
        ...
        if let user = PFUser.currentUser() {
            ...
            q4Query.whereKey("objectId", equalTo: (quizCont4?.objectId)!)
        ...
        if let user = PFUser.currentUser() {
            ...
            q5Query.whereKey("objectId", equalTo: (quizCont4?.objectId)!)
        ...
        let totalTimesTaken = quizCont4!["timesTaken"] as? Int
        ...
        //update global 1
        let got1Right = quizCont4!.relationForKey("q1Right")
        ...
        //update global 2
        let got2Right = quizCont4!.relationForKey("q2Right")
        ...
        //update global 3
        let got3Right = quizCont4!.relationForKey("q3Right")
        ...
        //update global 4
        let got4Right = quizCont4!.relationForKey("q4Right")
        ...
        //update global 5
        let got5Right = quizCont4!.relationForKey("q5Right")
