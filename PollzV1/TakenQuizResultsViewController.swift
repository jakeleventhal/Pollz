//
//  TakenQuizResultsViewController.swift
//  PollzV1
//
...
class TakenQuizResultsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let user = PFUser.currentUser() {
            ...
            q1Query.whereKey("objectId", equalTo: (quizCont?.objectId)!)
        ...
        if let user = PFUser.currentUser() {
            ...
            q2Query.whereKey("objectId", equalTo: (quizCont?.objectId)!)
        ...
        if let user = PFUser.currentUser() {
            ...
            q3Query.whereKey("objectId", equalTo: (quizCont?.objectId)!)
        ...
        if let user = PFUser.currentUser() {
            ...
            q4Query.whereKey("objectId", equalTo: (quizCont?.objectId)!)
        ...
        if let user = PFUser.currentUser() {
            ...
            q5Query.whereKey("objectId", equalTo: (quizCont?.objectId)!)
